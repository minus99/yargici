<div class="ems-page page-cart step1">
            ...
            <div class="ems-page-default ems-page-order-delivery">
                                        ...
                                        <div class="ems-form ems-form-horizontal">
                                            <div class="ems-form-inner">
                                                <div class="ems-field ems-field-check address-type">
                                                    <div class="address-type-title"><span>Teslimat Adresini Seçiniz</span></div>
                                                    <div class="ems-form-obj"><input type="radio"><span>Adresime Teslimat</span></div>
                                                ...
                                                <div class="ems-page-default-title"><span>Fatura Adresi seçiniz*</span></div>
                                                <div class="ems-field text clearfix">
                                                    ...
                                                    <div class="ems-field-right">
                                                        <div class="ems-form-obj"><select><option>TÜRKİYE</option><option>RUSYA</option><option>ALMANYA</option></select></div>
                                                    </div>
                                                </div>
                                                <div class="ems-field text clearfix">
                                                    <div class="ems-field-left">
                                                    ...
                                                    <div class="ems-field-right">
                                                        <div class="ems-form-obj"><select><option>İSTANBUL</option><option>ANKARA</option><option>İZMİR</option></select></div>
                                                    </div>
                                                </div>
                                                <div class="ems-field text clearfix">
                                                    <div class="ems-field-left">
                                                    ...
                                                    <div class="ems-field-right">
                                                        <div class="ems-form-obj"><select><option>ESENLER</option><option>ZEYTİNBURNU</option><option>BAKIRKÖY</option></select></div>
                                                    </div>
                                                </div>
                                                <div class="ems-field text ems-field-full textarea">
                                                    <div class="ems-form-label"><span>ADRES</span></div>
                                                    <div class="ems-form-obj"><textarea></textarea></div>
                                                </div>
                                                <div class="ems-field text ems-field-middle clearfix">
                                                    <div class="ems-field-right">
                                                ...
                                                <div class="ems-field ems-field-check">
                                                    <div class="ems-form-obj"><input type="radio"><span>Faturamı Fatura Kesim Adresime Gönder</span></div>
                                                ...
                                                <div class="ems-field ems-field-check ems-field-invoice-type">
                                                    ...
                                                    <div class="ems-form-obj ems-form-obj-full">
                                                        <input type="text" rel="1">
                                                        <input type="text" rel="2" style="display:none;">
                                                    </div>
                                                </div>
                                                <div class="ems-field ems-field-check ems-field-gift-type">
                                                    <div class="ems-field-left">
                                                        ...
                                                        <div class="ems-form-obj"><input type="radio"><span>Hediye Notu</span></div>
                                                        <div class="ems-form-obj"><textarea></textarea></div>
                                                    </div>
                                                    <div class="ems-field-right">
                                                ...
                                                <ul class="content-js">
                                                    <li rel="cart">
                                                        ...
                                                        <div class="content clearfix">
                                                            ...
                                                            <!--gift cart using-->
                                                            <div class="ems-gift-cart">
                                                                <div class="ems-form ems-form-horizontal">
                                                                    <div class="ems-form-inner">
                                                                        <div class="ems-field ems-field-check">
                                                                            <div class="ems-form-obj"><input type="checkbox"><span>Treasure / Gift Card’ını Kullan</span><i class="tooltip"></i></div>
                                                                        </div>
                                                                        <div class="ems-field text">
                                                                            <div class="ems-form-label"><span>Treasure / Gift Card'ını Kullan*</span></div>
                                                                            <div class="ems-form-obj"><input type="text"></div>
                                                                        </div>
                                                                        <div class="ems-field text">
                                                                            <div class="ems-form-label"><span>Güvenlik Kodu*</span></div>
                                                                            <div class="ems-form-obj"><input type="text"></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="ems-3d-secure">
                                                                    <img src="/lab/projects/yargici/images/3d-pay-icon.png" />
                                                                </div>
                                                            </div>
                                                            <!--gift cart using-->
                ...
                <div class="ems-page-default-right">
                    <div class="ems-cart-summary">
                        ...
                        <div class="ems-cart-coupon obj-step0">
                            <div class="ems-cart-coupon-header"><span>İndirim kuponu</span><i class="icon-ico_arw-fill-bttm"></i></div>
                            <div class="ems-cart-coupon-body">
                                <div class="ems-cart-coupon-use"><input type="text"><a href="javascript:void(0);" class="btn-default btn-default-coupon"><i class="icon-ico_arw-fill-right"></i></a></div>
                                <span class="ems-message ems-message-error"></span>
                            </div>
                        </div>
                    </div>
                    <!--Middle box-->
                    <div class="ems-cart-box">
                        <div class="ems-cart-box-inline">
                            <span>0,10 TL bağışlayarak, ödeme tutarını yuvarlayabilir ve seçtiğin sivil toplum kuruluşuna destek olabilirisn.</span>
                            <div class="ems-cart-box-select">
                                <select>
                                    <option>Sivil Toplum Kuruluşu Seçin</option>
                                    <option>Sivil Toplum Kuruluşu Seçin</option>
                                </select>
                            </div>
                            <div class="ems-cart-box-img"><img src="/lab/projects/yargici/images/social-icon-tema.png" /></div>
                        </div>    
                    </div>
                    <!--Middle box-->
                </div>
